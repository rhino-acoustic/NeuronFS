...
| 옵코드 | 룬 | 효과 | 예시 |
|---|---|---|---|
| 禁_ | Zod | **절대 금지** -- AI가 물리적으로 넘을 수 없는 벽 | 禁_하드코딩.neuron |
| 必_ | Ber | **필수 게이트** -- 반드시 통과해야 함 | 必_부서장승인.neuron |
| 推_ | Ist | **추천** -- 부드러운 넛지, 무시 가능 | 推_테스트코드.neuron |
| .axon | Jah | **텔레포트** -- 먼 뇌 영역을 연결 | 推_보험료.axon => [보험금/] |
