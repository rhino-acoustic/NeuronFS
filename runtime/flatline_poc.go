// flatline_poc.go — OOM Flatline Death Screen UX v2
//
...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// Stack Trace Parser — extractFaultNode
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

// appFileRegex matches non-runtime, non-stdlib source lines like:
//
//	/path/to/myfile.go:123 +0x4a
var appFileRegex = regexp.MustCompile(`(?m)^\s*(.+\.go):(\d+)\s`)

// extractFaultNode parses the raw stack trace and returns the first
// application-level source file + line number, skipping Go runtime internals.
// Returns "unknown" if nothing is parseable.
