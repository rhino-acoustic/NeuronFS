...
- ⚡ WHEN Go 코드 수정 후 → 추천: 코드변경후 govet실행
- ⚡ WHEN 코드 생성/갱신 시 → 추천: 코드생성갱신시 기존기능누락대조
- ⚡ WHEN 코드 수정 시 → 추천: 코드수정전 코드맵확인
- ⚡ WHEN 문서 변경 시 → README갱신
- ⚡ WHEN 해당 작업 시 → 추천: 도구특이성
- ⚡ WHEN 해당 작업 시 → 추천: 특정도구사용
- ⚡ WHEN 해당 작업 시 → 서브프로세스호출
- ⚡ WHEN 해당 작업 시 → 추천: 자동화
